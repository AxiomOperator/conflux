import { AgentMailPage } from "@/components/agentmail-page";
...
export const metadata = { title: "AgentMail - Admin | Conflux" };

export default async function AdminAgentMailPage() {
